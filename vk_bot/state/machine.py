...
class FiniteStateMachine:
    ...
    Manages states, transitions, and conditions.
    Supports state groups, on_enter/on_exit callbacks,
    conditional transitions, and priorities.
    """
    ...
    def __init__(self, name: str = "default"):
        ...
        self.on_any_transition: Callable | None = None
    ...
    def can_transition(
        self, from_state: str, to_state: str, context: Any = None
    ) -> bool:
    ...
    def get_next_states(self, from_state: str, context: Any = None) -> list[str]:
        ...
        for trans in self.transitions:
            if trans.from_state in {from_state, "*"}:
                if trans.condition:
...
class FSMRegistry:
    ...
    @classmethod
    def get(cls, name: str) -> FiniteStateMachine | None:
